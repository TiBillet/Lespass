# Generated by Django 4.2.24 on 2025-10-28 13:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True, help_text='Vous pouvez activer ou desactiver cette fonction pour la faire apparaitre dans le menu général.', verbose_name='Activer Crowds')),
                ('title', models.CharField(blank=True, default='Contribuez', max_length=255, verbose_name='Titre')),
                ('description', models.TextField(blank=True, default='Découvrez les projets à financer et les budgets contributifs')),
                ('vote_button_name', models.CharField(blank=True, default="Ça m'intérèsse !", max_length=255, verbose_name='Nom du bouton de vote')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget_contributif', models.BooleanField(default=False, help_text="Permettez a votre communauté de proposer des actions qui s'inscrivent dans un budget contributif : https://movilab.org/wiki/Coremuneration_et_budget_contributif", verbose_name='Budget contributif')),
                ('currency', models.CharField(default='€', help_text='Changez la valeur de la contribution : Comptez en €, monnaie locale, monnaie temps, bonbons ?', max_length=250, verbose_name='Valeur')),
                ('direct_debit', models.BooleanField(default=False, help_text='Réclamer le paiement de la contribution financière en ligne. Cela redirigera la personne sur Stripe pour un paiement.', verbose_name='Paiement direct')),
