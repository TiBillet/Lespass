...
### Le webhook d'adhésion partait avant que l'adhésion existe en base
...
### Vérif automatisée / Automated check

```bash
docker exec lespass_django poetry run pytest /DjangoFiles/tests/pytest/test_webhook_membership_on_commit.py -v
```
