...
Nous attachons beaucoup d'importance à la notion de communs [(1)](https://fr.wikipedia.org/wiki/Communs) [(2)](https://lescommuns.org/).

Nous nous sommes constitués en société coopérative d'intérêt collectif ([SCIC](https://www.les-scic.coop/))
...
Le logiciel libre n'est pas pour nous une fin en soi, mais une méthode de construction de ressources communes : Les licences libres apportent la transparence indispensable à la confiance entre membres d'une communauté pour l'usage et la fabrication de communs numériques.

Nous ajoutons à ces valeurs des notions de gouvernance orientées sur la réciprocité.
...
- [Transparence et budgets contributifs](https://codecommun.tibillet.coop/crowd/) : chacun·e est rémunéré·e en fonction de ce qu'iel estime juste et en toute transparence.
...
### Transparence des actions, mutualisation des outils
...
### 3 catégories d'associés : 3 collèges de vote
...
Nous administrons et installons des solutions pour vous, mais vous restez propriétaires de vos données comme des serveurs sur lesquels elles sont hébergées. Nous ne revendons pas vos données, nous ne les utilisons pas à des fins commerciales.
