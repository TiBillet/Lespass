...
# La cle est le nom de l'icone Material (ligature) : la caisse l'affiche tel quel
# avec <span class="material-symbols-outlined">nom</span>, police locale fournie
# par django-unfold. Chaque nom doit exister dans cette police
# (verifie par tests/pytest/test_laboutik_icones.py).
# Licence : Apache 2.0. Liste : https://fonts.google.com/icons
# Les anciens noms FontAwesome deja en base sont convertis par la migration
# laboutik/migrations/*_icones_fontawesome_vers_material.py
# / The key is the Material icon name, shown as-is by the POS. Stored FontAwesome
#   names are converted by a data migration.
# ---------------------------------------------------------------------------

ICON_POS = [
    # Boissons / Drinks
    ("sports_bar", _("Biere")),
    ("wine_bar", _("Vin rouge / rose")),
    ("glass_cup", _("Vin blanc")),
    ("liquor", _("Bouteille vin")),
    ("local_bar", _("Cocktail / bar")),
    ("local_drink", _("Spiritueux / soda")),
    ("celebration", _("Champagne / fete")),
    ("nightlife", _("Martini / apero")),
    ("coffee", _("Cafe")),
    ("emoji_food_beverage", _("The / boisson chaude")),
    ("water_drop", _("Eau")),
    ("water_full", _("Jus / limonade")),
    ("blender", _("Smoothie / milkshake")),
    ("science", _("Biere artisanale")),
    ("medication_liquid", _("Shot / fiole")),
    ("water", _("Eau minerale / source")),
    # Nourriture / Food
    ("restaurant", _("Restaurant / plat")),
    ("local_pizza", _("Pizza")),
    ("lunch_dining", _("Burger")),
    ("fastfood", _("Hot-dog / foodtruck")),
    ("bakery_dining", _("Sandwich / boulangerie")),
    ("tapas", _("Fromage / plateau")),
    ("egg", _("Brunch / petit-dej")),
    ("nutrition", _("Fruit / bio")),
    ("eco", _("Salade / vegetal")),
    ("potted_plant", _("Bio / vegan")),
    ("cookie", _("Dessert / gouter")),
    ("donut_small", _("Snack")),
    ("icecream", _("Glace")),
    ("outdoor_grill", _("Grill / BBQ")),
    ("set_meal", _("Poisson / fruits de mer")),
    ("grass", _("Legume / veggie")),
    ("whatshot", _("Epice / piment")),
    ("donut_large", _("Confiserie / sucre")),
    ("breakfast_dining", _("Gaufre / crepe")),
    ("kebab_dining", _("Charcuterie / bacon")),
    ("cake", _("Gateau d'anniversaire")),
    # Cashless / Monnaie
    ("toll", _("Recharge euros")),
    ("account_balance_wallet", _("Wallet / solde")),
    ("payments", _("Especes")),
    ("credit_card", _("Carte bancaire")),
    ("checkbook", _("Cheque")),
    ("euro", _("Euro")),
    ("attach_money", _("Dollar")),
    ("currency_pound", _("Livre sterling")),
    ("currency_ruble", _("Rouble")),
    ("currency_lira", _("Lire / livre turque")),
    ("currency_rupee", _("Roupie")),
    ("currency_yen", _("Yen / yuan")),
    ("universal_currency_alt", _("Shekel")),
    ("currency_exchange", _("Won")),
    ("redeem", _("Recharge cadeau")),
    ("diamond", _("Jeton premium")),
    ("schedule", _("Recharge temps")),
    # Adhesion / Abonnement
    ("badge", _("Adhesion / membre")),
    ("person_add", _("Nouvel adherent")),
    ("group", _("Communaute / asso")),
    ("handshake", _("Partenariat / cooperative")),
    ("favorite", _("Don / soutien")),
    ...
    ("theater_comedy", _("Theatre")),
    ("camping", _("Festival / camping")),
    ("directions_bus", _("Navette / transport")),
    ("apparel", _("T-shirt / vetement")),
    ("auto_fix_high", _("Chapeau / coiffe")),
    ("checkroom", _("Chaussettes / accessoire")),
    ("shopping_bag", _("Sac / tote bag")),
    ("menu_book", _("Livre / fanzine")),
    ("album", _("CD / vinyle")),
    ("palette", _("Art / serigraphie")),
    ...
    ("door_open", _("Entree / accueil")),
    ("location_on", _("Lieu / emplacement")),
    ("home", _("Maison / local")),
    ("warehouse", _("Hangar / entrepot")),
    ("local_shipping", _("Foodtruck / camion")),
    ("airport_shuttle", _("Navette / van")),
    ("rv_hookup", _("Caravane / roulotte")),
    ("park", _("Jardin / exterieur")),
    ("local_fire_department", _("Feu / barbecue")),
    ("sunny", _("Plein air / ete")),
    # Actions / Danger
    ("warning", _("Danger / attention")),
    ("delete", _("Vider / supprimer")),
    ("undo", _("Annuler / remboursement")),
    ("swap_horiz", _("Consigne / echange")),
    ("recycling", _("Consigne retour")),
...
class MembershipPriceInlineForm(BasePriceInlineForm):
    ...
    def clean_recurring_payment(self):
        ...
        if self.cleaned_data.get("subscription_type") not in [
            Price.DAY,
            Price.WEEK,
            Price.MONTH,
            Price.CAL_MONTH,
