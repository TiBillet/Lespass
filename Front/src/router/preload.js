...
// charge un évènement
export async function event(to, frm, next) {  
  // pas de préchargement sur un tenant de categorie "M"
  if (to.query.categorie !== "M") {
    ...
    try {
      ...
      log({
        message: `loadEvent, /api/eventslug/${to.params.slug}, error: `,
        error,
      });
