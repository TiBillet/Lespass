...
Ce dossier garde les points **identifiés, instruits et volontairement non
corrigés**. Ce ne sont ni des idées ni des souhaits : chacun a été mesuré, avec
un scénario d'échec et un correctif chiffré.

La différence avec le reste de `CHANGELOG/` : ici, rien n'est fait.
...
une ligne d'explication dans le fichier qui le portait — pas silencieusement.
