<template>
  <CreationStep title="Créer votre espace">
    <template #creation-title> Sélectionner, éditer un type d'espace. </template>
    <template #creation-tabs-content>
      ...
      <div id="informations" class="creation-tab-content">
        <div class="espace-content d-flex flex-column">
          ...
          <div class="creation-group">
            <textarea id="creation-long-description" class="creation-input" placeholder="Votre longue description" v-model="formCreatePlace.long_description" rows="3"></textarea>
            <label class="creation-group-label" for="creation-long-description">Longue description</label>
          </div>
-->
          ...
          <div class="creation-group">
            <input type="file" id="creation-img-url" class="creation-input" @change="fileChange($event, 'image')" />
            <label class="creation-group-label" for="creation-img-url">Url image</label>
          </div>
          
          <div class="creation-group">
            <input type="file" id="creation-logo-url" class="creation-input" @change="fileChange($event, 'logo')" />
            <label class="creation-group-label" for="creation-logo-url">Url logo</label>
          </div>
        </div>
      </div>
