    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('federated_with', models.ManyToManyField(blank=True, help_text='Lieux qui ont accepte de partager cet asset.', related_name='assets_federated', to='Customers.client', verbose_name='Lieux federes')),
                ('pending_invitations', models.ManyToManyField(blank=True, help_text="Lieux invites a partager cet asset. Ils verront l'invitation dans leur admin et pourront accepter.", related_name='asset_invitations_pending', to='Customers.client', verbose_name='Invitations en attente')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, help_text='Le lieu qui a cree cette federation. Lui seul peut envoyer des invitations.', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='federations_created', to='Customers.client', verbose_name='Cree par')),
                ('pending_tenants', models.ManyToManyField(blank=True, help_text="Lieux invites a rejoindre cette federation. Ils verront l'invitation dans leur admin et pourront accepter.", related_name='federation_invitations_pending', to='Customers.client', verbose_name='Invitations en attente')),
                ('tenants', models.ManyToManyField(blank=True, help_text='Lieux qui ont accepte de rejoindre cette federation.', related_name='federations', to='Customers.client', verbose_name='Tenants membres')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('FST', 'Genesis'), ('CRE', 'Creation'), ('RFL', 'Recharge'), ('SAL', 'Vente'), ('QRS', 'Vente QR'), ('FUS', 'Fusion'), ('RFD', 'Remboursement'), ('VOI', 'Annulation'), ('DEP', 'Depot bancaire'), ('TRF', 'Virement'), ('BTR', 'Virement bancaire pot central')], max_length=3, verbose_name='Action')),
                ...
                ('tenant', models.ForeignKey(help_text='Lieu concerne — TOUJOURS filtrer par ce champ dans les vues', on_delete=django.db.models.deletion.PROTECT, related_name='fedow_transactions', to='Customers.client', verbose_name='Tenant')),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='asset',
            constraint=models.UniqueConstraint(condition=models.Q(('category', 'FED')), fields=('category',), name='unique_fed_asset'),
        ),
    ]
